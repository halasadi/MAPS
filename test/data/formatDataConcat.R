...
ibdM = readIBD(paste0(workingDir, "heterpopsizes_nsamp_20_mt_300_1.out.qc.ibd"), nhaploids, lowerCutOff, upperCutoff)

for (i in 2:nchr){
  ibdM = ibdM + readIBD(paste0(workingDir, "heterpopsizes_nsamp_20_mt_300_", i, ".out.qc.ibd"), nhaploids, lowerCutOff, upperCutoff)
}

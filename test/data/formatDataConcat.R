...
ibdM = readIBD(paste0(workingDir, "recent_barrier_mt_300gen_nsamp_20_18.out.qc.ibd"), nhaploids, lowerCutOff, upperCutoff)

for (i in 2:nchr){
  print(paste0("on chr: ", i))
  ibdM = ibdM + readIBD(paste0(workingDir, "recent_barrier_mt_300gen_nsamp_20_", i, ".out.qc.ibd"), nhaploids, lowerCutOff, upperCutoff)
}

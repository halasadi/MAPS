...
Eigen::MatrixXd rcppdont_standardize_rates(const Eigen::VectorXd &tilex, const Eigen::VectorXd &rates,
					   const Eigen::VectorXd &xseed, const Eigen::VectorXd &yseed,
					   const Eigen::MatrixXd &marks, const Eigen::VectorXd &nmrks,
					   const std::string &distm);
RcppExport SEXP rEEMSplots2__rcppstandardize_rates( SEXP tiles_, SEXP rates_, SEXP xseed_, SEXP yseed_,
...
RcppExport SEXP rEEMSplots2__rcppdont_standardize_rates( SEXP tiles_, SEXP rates_, SEXP xseed_, SEXP yseed_,
							 SEXP marks_, SEXP nmrks_, SEXP distm_) {
BEGIN_RCPP
  SEXP Zmrks_;
  {
    ...
    Eigen::MatrixXd Zmrks = rcppdont_standardize_rates(tiles,rates,xseed,yseed,marks,nmrks,distm);
